        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              ...
              <p>This Medical Appointment booking Website is made by Vinayak Singh for my client to get online appointment. Customers Can Schedule an Appointment with you in under a Minute.
              </p>
            </div>
            <footer>
              <ul className="tech-list">
